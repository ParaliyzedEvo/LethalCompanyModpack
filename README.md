...
301 mods that are pretty useful ngl. Will add more if I want

## Mods in the modpack

    "FlipMods-ReservedItemSlotCore-1.8.8",
    "x753-Mimics-2.3.2",
    "Mom_Llama-Lethal_Company_Enhancer-0.1.10",
    "FlipMods-ReservedFlashlightSlot-1.5.8",
    "xCeezy-LethalEscape-0.8.5",
    "Dielji-StreamerSuits-1.1.8",
    "BLKNeko-HookGun-1.3.4",
    "Pooble-LCBetterSaves-1.7.0",
    "HolographicWings-LethalExpansion-1.3.18",
    "malco-Lategame_Upgrades-2.8.8",
    "2018-LC_API-3.3.2",
    "FlipMods-ReservedWalkieSlot-1.5.4",
    ...
    "Badham_Mods-SCPFoundationDungeon-1.5.0",
    "FlipMods-TooManyEmotes-1.7.9",
    "Electric131-OuijaBoard-1.5.1",
    ...
    "IAmBatby-LethalLevelLoader-1.0.5",
    "AlexCodesGames-AdditionalContentFramework-1.0.2",
    "Ozone-Runtime_Netcode_Patcher-0.2.5",
    "Sligili-More_Emotes-1.3.2",
    "MetalPipeSFX-HornMoan-2.1.0",
    "Ceelery-Kast-1.0.3",
    "Zingar-SecretLabs-3.2.4",
    "yeahimliam-Peter_Griffin_Suit-1.0.1",
    "scoopy-Scoopys_Variety_Mod-0.6.4",
    "kuba6000-LC_Masked_Fix-0.0.2",
    "FireNoobsta-Ducks_Moons-1.1.3",
    "extraes-LethalLoudnessMeter-1.0.1",
    "atg-FnafPowerOutage-1.0.1",
    "Mhz-MoreHead-1.2.3",
    "KayNetsua-E_Gypt_Moon-2.0.0",
    "Team_Waluigi-WaluigiSuit-0.0.3",
    "TheFluff-FairAI-1.2.8",
    "Jamil-Corporate_Restructure-1.0.6",
    "JunLethalCompany-GamblingMachineAtTheCompany-1.2.3",
    "darmuh-darmuhsTerminalStuff-2.2.2",
    "NomnomAB-RollingGiant-2.3.0",
    "AinaVT-LethalConfig-1.3.4",
    "Gemumoddo-LethalEmotesAPI-1.1.12",
    "Gemumoddo-BadAssCompany-1.1.0",
    "Jordo-NeedyCats-1.1.1",
    "sfDesat-Aquatis-0.4.2",
    "IntegrityChaos-Diversity-1.1.10",
    "TeamBridget-Peaches_Castle-1.0.41",
    "EliteMasterEric-SlimeTamingFix-1.0.2",
    "Melexan-HeyItsMeGoku-1.0.0",
    "GhostbustingTrio-CustomFunSuits-1.8.2",
    "linkoid-DissonanceLagFix-1.0.0",
    "jockie-LethalExpansionCore-1.3.14",
    "Nuts-LethalPlushies-1.7.1",
    "goblinfiend-PlushiesPlus-3.0.0",
    "ViViKo-NoSellLimit-1.0.1",
    "Panton-Racist_Hoarding_Bugs-2.0.2",
    "CHILLAX-ChillaxSCRAPS-0.5.2",
    "CTMods-KarmaForBeingAnnoying-1.1.0",
    "Kats-Some_Suits-1.0.6",
    "OE_Tweaks-Possessed_Masks-1.1.2",
    "MrHydralisk-EnhancedRadarBooster-1.5.4",
    "taffyko-BetterSprayPaint-1.1.0",
    "ViViKo-AllTheScrap-1.0.1",
    "Repyl-PeterGriffinHouse-3.4.3",
    "darmuh-ghostCodes-1.1.0",
    "2018-Movement_Company-1.0.2",
    ...
    "TheBeeTeam-LandmineFix-1.0.1",
    "Insomniax-InsomniaxCosmetics-1.0.5",
    "Hexa-Hexas_Cosmetics-0.0.2",
    "happyfrosty-FrostyCosmetics-1.0.7",
    "FlipMods-ReservedSprayPaintSlot-1.0.5",
    "quackandcheese-MinecraftTaigaMoon-1.1.1",
    "bandaidroo-BandaidsMegaCosmetics-1.0.0",
    "SlushyRH-FreeeeeeMoooooons-1.0.1",
    "Pinta-PintoBoy-1.0.3",
    "BGN-PizzaTowerEscapeMusic-2.1.0",
    "HolographicWings-ChristmasVillage_Legacy-1.3.16",
    "Electric131-IsThisTheWayICame-1.1.4",
    "cartoonist103-YIPEE-1.0.0",
    "DCBlack-Ghost_Buster_Uniform-1.1.5",
    "ShaosilGaming-FlashlightFix-1.0.5",
    "Spyci-CozyImprovements-1.2.1",
    "rainbow137-MinecraftScraps-1.4.0",
    "PuffyMods-Beekeeper_Suit-1.1.0",
    "Kittenji-LaserPointerDetonator-1.0.0",
    "broiiler-inacraft_cosmetics_megapack-1.0.1",
    "PostMortem-BetterLightning-1.0.3",
    "Dunn-HEV_Suit-1.2.0",
    "Nebulaetrix-BetterPresents-1.0.3",
    "ZTK-ZTKCosmetics-2.0.0",
    "nerdcat-SillyCosmetics-1.8.0",
    "fonnymunkey-SimpleHats-1.0.0",
    "TheFluff-GetLootForKills-1.2.0",
    "ohotdog-LootableMusicTapes-1.0.1",
    "kelp-Adidas_Suit-1.0.1",
    "alexsio-gamba_mod-1.0.8",
    "Dafini-Dafis_Mega_Moon_Pack_Emporium-1.3.4",
    "MagicalFlyingPurpleTreeSquid-Drive_Suit-1.0.3",
    "willis81808-HackPad-1.1.3",
    "SpookyDookies-Spooky_Dookies_Glowsuits-1.1.8",
    "Regretti-ClassicDoomguy-1.0.0",
    "red_eye-LethalAutocomplete-0.4.1",
    "SnoopCave-I_need_more_Bullets-1.0.0",
    "Caigan-Tokucade_Scrap-1.4.0",
    "Luck-LuckReservedBoombox-1.0.6",
    "Frostty-LC_Nuketown-1.0.0",
    "BunyaPineTree-ModelReplacementAPI-2.3.6",
    "FoxGod-ThiccCompanyModelReplacement-1.1.1",
    "YourFurnace-ThickWomanSuit-1.0.0",
    "larryr1-LukesAdditionalSuits-1.0.4",
    "DisappointedScrubs-More_Suits_Scrub_Skins-1.0.6",
    "Tolnin-TolninsDragonBallSkins-1.0.3",
    "Kittenji-Maxwell_ScrapItem-1.0.1",
    "Sakura-LandminesForAll-1.0.1",
    "MoonJuice-MyLeg-1.0.3",
    "Woecust-Immersive_Visor-0.2.1",
    "LoddZee-Capybara_MouthDog-1.2.0",
    "FREAKS-SuitsPlus-2.0.1",
    "Hamunii-JetpackWarning-2.2.0",
    "silhygames-FumoCompany-1.2.0",
    "ViViKo-AnimatedSuits-1.2.0",
    "RaspberryProgramming-NoDeathDespawn-1.0.0",
    "EladNLG-EladsHUD-1.2.1",
    "KlutzyBubbles-BetterEmotes-1.3.4",
